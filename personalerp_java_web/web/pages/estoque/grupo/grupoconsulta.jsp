...
<aside>
	<label class="TituloTela">Consulta de Grupos</label>
	...
	<div class="FormularioConsulta FormularioGeral">
		...
		<div class="DataGridConsulta" data-page="grupoconsulta.grid.erp" data-page-size="10" data-detail-page="grupocadastro.erp"></div>
