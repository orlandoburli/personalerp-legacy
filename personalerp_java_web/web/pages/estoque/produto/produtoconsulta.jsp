...
<aside>
	<label class="TituloTela">Consulta de Produtos</label>
	...
	<div class="FormularioConsulta FormularioGeral">
		...
		<div class="DataGridConsulta" data-page="produtoconsulta.grid.erp" data-page-size="10" data-detail-page="produtocadastro.erp"></div>
