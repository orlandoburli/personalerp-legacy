...
<aside>
	<label class="TituloTela">Consulta de Menus</label>
	...
	<div class="FormularioConsulta FormularioGeral">
		...
		<div class="DataGridConsulta" data-page="menuconsulta.grid.erp" data-page-size="10" data-detail-page="menucadastro.erp"></div>
