package br.com.orlandoburli.personalerp.model.acesso.perfil.permissaoperfilobjeto.permissaoperfilacaoobjeto.vo;
...
public class PermissaoPerfilAcaoObjetoVO implements IValueObject {
	...
	@Formula("(SELECT NomeAcaoObjeto FROM [schema].AcaoObjeto b WHERE b.CodigoObjeto = a.CodigoObjeto AND b.CodigoAcaoObjeto = a.CodigoAcaoObjeto)")
	private String NomeAcaoObjeto;
	
	@Formula("(SELECT NomeObjeto FROM [schema].Objeto c WHERE c.CodigoObjeto = a.CodigoObjeto)")
