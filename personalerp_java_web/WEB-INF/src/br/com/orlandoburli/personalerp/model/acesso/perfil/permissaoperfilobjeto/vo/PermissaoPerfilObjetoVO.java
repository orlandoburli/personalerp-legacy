package br.com.orlandoburli.personalerp.model.acesso.perfil.permissaoperfilobjeto.vo;
...
public class PermissaoPerfilObjetoVO implements IValueObject {
	...
	@Formula("(SELECT b.NomeObjeto FROM [schema].Objeto b WHERE a.CodigoObjeto = b.CodigoObjeto)")
	private String NomeObjeto;

	@Formula("(SELECT c.DescricaoObjeto FROM [schema].Objeto c WHERE a.CodigoObjeto = c.CodigoObjeto)")
	private String DescricaoObjeto;
	
	@Formula("(SELECT d.NomePerfil FROM [schema].Perfil d WHERE a.CodigoPerfil = d.CodigoPerfil AND a.CodigoEmpresa = d.CodigoEmpresa AND a.CodigoLoja = d.CodigoLoja)")
