...
public class LojaVO implements IValueObject {
	...
	@Formula(getFormula = "(select c.siglaestado from [schema].cidade b join [schema].estado c on c.codigoestado = b.codigoestado where b.codigocidade = a.codigocidadeloja)")
	private String UFLoja;
	@Formula(getFormula = "(select c.regiaoestado from [schema].cidade b join [schema].estado c on c.codigoestado = b.codigoestado where b.codigocidade = a.codigocidadeloja)")
	private String RegiaoLoja;
	
	@Formula(getFormula="(SELECT f1.NomeFuncionario FROM [schema].Funcionario f1 WHERE f1.CodigoEmpresa = a.CodigoEmpresaFuncionarioSupervisor AND f1.CodigoLoja = a.CodigoLojaFuncionarioSupervisor AND f1.CodigoFuncionario = a.CodigoFuncionarioSupervisor)")
	private String NomeFuncionarioSupervisor;

	@Formula(getFormula="(SELECT f1.NomeFuncionario FROM [schema].Funcionario f1 WHERE f1.CodigoEmpresa = a.CodigoEmpresaFuncionarioGerente AND f1.CodigoLoja = a.CodigoLojaFuncionarioGerente AND f1.CodigoFuncionario = a.CodigoFuncionarioGerente)")
	private String NomeFuncionarioGerente;
	
	@Ignore
	private String Permitido;
	
	@Formula(getFormula="(SELECT e.RazaoSocialEmpresa FROM [schema].Empresa e WHERE e.CodigoEmpresa = a.CodigoEmpresa)")
	private String RazaoSocialEmpresa;
	
	@Formula(getFormula="(SELECT e.FantasiaEmpresa FROM [schema].Empresa e WHERE e.CodigoEmpresa = a.CodigoEmpresa)")
	...
	public String getNomeFuncionarioSupervisor() {
		return NomeFuncionarioSupervisor;
	}

	public void setNomeFuncionarioSupervisor(String nomeFuncionarioSupervisor) {
		NomeFuncionarioSupervisor = nomeFuncionarioSupervisor;
	}

	public String getNomeFuncionarioGerente() {
		return NomeFuncionarioGerente;
	}

	public void setNomeFuncionarioGerente(String nomeFuncionarioGerente) {
		NomeFuncionarioGerente = nomeFuncionarioGerente;
	}
