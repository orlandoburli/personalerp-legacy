...
public class ItemRomaneioBeneficiadaVO implements IValueObject {
    ...
    private String NomeProdutoMadeiraBeneficiada;
    ...
    @Formula(getFormula="(SELECT b.CodigoTipoMadeiraBeneficiada FROM [schema].Produto b WHERE a.CodigoEmpresaProduto = b.CodigoEmpresa AND a.CodigoLojaProduto = b.CodigoLoja AND a.CodigoProduto = b.CodigoProduto)")
    ...
    @Ignore
    private BigDecimal AreaTotalItemRomaneio;
	...
	public void setNomeProdutoMadeiraBeneficiada(
			String nomeProdutoMadeiraBeneficiada) {
		NomeProdutoMadeiraBeneficiada = nomeProdutoMadeiraBeneficiada;
	}

	public String getNomeProdutoMadeiraBeneficiada() {
		return NomeProdutoMadeiraBeneficiada;
	}

	public void setAreaTotalItemRomaneio(BigDecimal areaTotalItemRomaneio) {
		AreaTotalItemRomaneio = areaTotalItemRomaneio;
	}

	public BigDecimal getAreaTotalItemRomaneio() {
		return AreaTotalItemRomaneio;
	}
