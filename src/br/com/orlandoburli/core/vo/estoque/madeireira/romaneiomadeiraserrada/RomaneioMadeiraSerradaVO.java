package br.com.orlandoburli.core.vo.estoque.madeireira.romaneiomadeiraserrada;
...
public class RomaneioMadeiraSerradaVO implements IValueObject {
    ...
    @Formula(getFormula="(SELECT f.NomeFuncionario FROM [schema].GerenteMadeireira c " +
    		" JOIN [schema].ContratoTrabalho d ON d.CodigoEmpresa = c.CodigoEmpresaContratoTrabalho " +
    		"                                 AND d.CodigoLoja = c.CodigoLojaContratoTrabalho " +
    		"                                 AND d.CodigoContratoTrabalho = c.CodigoContratoTrabalho " +
    		" JOIN [schema].Funcionario f ON f.CodigoEmpresa = d.CodigoEmpresaFuncionario " +
    		"                            AND f.CodigoLoja = d.CodigoLojaFuncionario " +
    		"                            AND f.CodigoFuncionario = d.CodigoFuncionario " +
    		" WHERE c.CodigoEmpresa = a.CodigoEmpresaGerente " +
    		"   AND c.CodigoLoja = a.CodigoLojaGerente " +
    		"   AND c.CodigoGerente = a.CodigoGerente)")
    private String NomeGerente;
    
    @Formula(getFormula="CAST (EXTRACT(YEAR FROM a.DataRomaneio) AS INTEGER)")
    private Integer AnoRomaneio;
	...
	public void setAnoRomaneio(Integer anoRomaneio) {
		AnoRomaneio = anoRomaneio;
	}

	public Integer getAnoRomaneio() {
		return AnoRomaneio;
	}
}