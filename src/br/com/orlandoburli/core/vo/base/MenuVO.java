...
public class MenuVO implements IValueObject {
    ...
    @Formula(getFormula="(SELECT COUNT(*) FROM [schema].Menu b WHERE b.CodigoMenuPai = a.CodigoMenu)")
    private Long CountChild;
    
    @Formula(getFormula="(SELECT c.NomeObjeto FROM [schema].Objeto c WHERE a.CodigoObjeto = c.CodigoObjeto)")
    private String NomeObjeto;
    
    @Formula(getFormula="(SELECT d.NomeMenu FROM [schema].Menu d WHERE a.CodigoMenuPai = d.CodigoMenu)")
