...
public class ComissaoRomaneadorMadeiraSerradaAction implements ICalculoComissao {

	private BigDecimal valorComissaoDSR;
	
	@Override
	public BigDecimal calcularImpactoDSR(ContratoTrabalhoVO contrato,
	...
	@Override
	public BigDecimal calcular(ContratoTrabalhoVO contrato,
			FolhaPagamentoVO folha, VerbaVO verba,
			VerbaContratoTrabalhoVO verbaContrato,
