...
public class MadeiraSerradaCadastroFacade extends BaseCadastroFlexFacade<ProdutoVO, ProdutoDAO> {

	private static final long serialVersionUID = 1L;

	public MadeiraSerradaCadastroFacade(HttpServletRequest request,
	...
	public boolean doBeforeSave() throws SQLException {
		this.getVo().setTipoEstoqueProduto("S"); // Tipo Madeira Serrada
		...
		vo2.setTipoEstoqueProduto("S"); // Tipo SERRADA
		boolean found = false;
