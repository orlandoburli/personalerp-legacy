...
public class ListagemUsuarioFacade extends BaseRelatorioFacade {
	
	public ListagemUsuarioFacade(HttpServletRequest request, HttpServletResponse response, ServletContext context, String methodName) {
