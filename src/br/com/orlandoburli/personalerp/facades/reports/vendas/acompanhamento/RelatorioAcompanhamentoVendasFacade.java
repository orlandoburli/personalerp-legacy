package br.com.orlandoburli.personalerp.facades.reports.vendas.acompanhamento;
...
public class RelatorioAcompanhamentoVendasFacade extends BaseRelatorioFacade {
	...
	protected String getJasperFileName() {
		return "reports/relatorioAcompanhamentoVendas.jasper";
	}
	...
	public JRDataSource getDataSource() {
		 ...
		 * CodigoEmpresa = '2'  
		 * AND CodigoLoja = '1'  
		 * AND CodigoEmpresaVendedor = '1'  
		 * AND CodigoLojaVendedor = '1'  
		 * AND CodigoVendedor = '26'  
		 * AND (  DataVenda >= '2012-03-01' AND DataVenda <= '2012-03-31' ) 
		 */
		setCodigoEmpresaVendedor(1);
		setCodigoLojaVendedor(1);
		setCodigoVendedor(26);
		
		setDataInicial(Date.valueOf("2012-03-01"));
		setDataFinal(Date.valueOf("2012-03-07"));
