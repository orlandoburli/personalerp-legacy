package br.com.orlandoburli.personalerp.facades.reports.estoque.madeireira.romaneiotora;
...
public class RelatorioRomaneioToraFacade extends BaseRelatorioFacade {
	...
	public RelatorioRomaneioToraFacade(HttpServletRequest request,
	...
	protected String getJasperFileName() {
		return "reports/relatorioRomaneioEntradaTora.jasper";
	}
